...
private slots:
    void enterCellSlot(const int row, const int col)
    {
    ...
    void leaveCellSlot(const int row, const int col)
    {
    ...
    void clickCellSlot(const int row, const int col)
    {
...
public:
    ...
    explicit Field(const Owner owner, QWidget* parent = nullptr)
        : m_owner{ owner }
