...
{
    m_dropTheBombMiss->setSource(QUrl("qrc:/resources/events/drop_the_bomb(miss).wav"));
    m_dropTheBombMiss->setVolume(0.3);
    m_dropTheBombHit->setSource(QUrl("qrc:/resources/events/drop_the_bomb(hit).wav"));
    m_dropTheBombHit->setVolume(0.1);
    m_dropTheBombDestroy->setSource(QUrl("qrc:/resources/events/drop_the_bomb(destroy).wav"));
